...
<!-- Footer -->
<footer class="page-footer font-small cyan darken-3" style="background:#17a2b8 ;color:white; position:relative;bottom:0">
<style>
    a:link, a:visited {
        color: white;
        padding: 15px 25px;
    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mx-auto">
                ...
                <!-- Links -->
                <h5 class="font-weight-bold text-uppercase mt-3 mb-4">Meet us on</h5>
    ...
    <div class="footer-copyright text-center py-3">© 2022 Copyright:
        <a href="/"> Mausham-Aligent-BE-Fast-Track</a>
    </div>
    <!-- Copyright -->
