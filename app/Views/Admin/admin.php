...
<form action="/admin" method="post">
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        ...
        <input class="form-control form-control-dark w-100" type="text" placeholder="Enter User email to search" aria-label="Search" name="search">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php echo $user['userProfilePic'] ?></td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
