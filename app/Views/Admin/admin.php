        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <form action="/admin" method="post" class="form-inline" style="float: right; margin-top: 20px">
                    <input class="form-control mr-sm-2" type="text" id="email" placeholder="Enter email or user id"
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <?php foreach ($allData['users'] as $user): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo $user['userProfilePic'] ?>" target="_blank">Click to
                                            view</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <?php foreach ($deletedPosts as $deletedPost): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo $deletedPost['imageUrl'] ?>" target="_blank">Click to
                                            view</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            ...
                            <?php foreach ($deletedUsers as $deletedUser): ?>
                                <tr>
                                    ...
                                    <td><?php $accessLevel = $deletedUser['accessLevel'] == 0 ? 'user' : 'Admin';
                                        echo $accessLevel ?></td>
                                    <td><a href="<?php echo $deletedUser['userProfilePic'] ?>" target="_blank">Click to
                                            view</a></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
